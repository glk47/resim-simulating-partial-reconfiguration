...
rsv_create_portmap "region_if" "clk"
rsv_add_port "region_if" "rstn"           in
rsv_add_port "region_if" "rc_reqn"        in
rsv_add_port "region_if" "rc_ackn"        out
rsv_add_port "region_if" "p_prdy"         out
rsv_add_port "region_if" "p_crdy"         in
rsv_add_port "region_if" "p_cerr"         in
rsv_add_port "region_if" "p_data"         out 32
rsv_add_port "region_if" "c_prdy"         in
rsv_add_port "region_if" "c_crdy"         out
rsv_add_port "region_if" "c_cerr"         out
rsv_add_port "region_if" "c_data"         in  32
...
# 
# Meanwhile rr0 & rr1 share same type of error_injector (i.e., "math_ei"), whereas
# rr2 has its own type of error_injector (i.e., "lpfilter_ei")

rsv_create_region "math_0_rr" "region_if" 4 "" "math_ei"
rsv_add_module "math_0_rr" "maximum" ""
rsv_add_module "math_0_rr" "reverse" ""

rsv_create_region "math_1_rr" "region_if" 4 "" "math_ei"
rsv_add_module "math_1_rr" "reverse" ""
rsv_add_module "math_1_rr" "maximum" ""

rsv_create_region "lpfilter_2_rr" "region_if" 6 "" "lpfilter_ei"
...
# Copy backup to the generated files. The lpfilter_2_rr region uses a customized 
# error_injector whereas the math_0_rr & math_1_rr use the default one. 
# 
# The script also copied a pre-defined memory file containing SBT sequences used
# by the testbench
